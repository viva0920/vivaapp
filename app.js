...
(function () {
  ...
  function stickerSvg(kind) {
    if (kind === "cat") return '<img class="sticker-img" src="sticker-cat.png?v=12" alt="小猫" />';
    if (kind === "dog") return '<img class="sticker-img" src="sticker-dog.png?v=12" alt="小狗" />';
    if (kind === "rabbit") return '<img class="sticker-img" src="sticker-rabbit.png?v=12" alt="小兔" />';
    return "";
  }
