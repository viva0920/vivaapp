...
(function () {
  ...
  function stickerSvg(kind) {
    if (kind === "cat") return '<img class="sticker-img" src="sticker-cat.png?v=16" alt="小猫" />';
    if (kind === "dog") return '<img class="sticker-img" src="sticker-dog.png?v=16" alt="小狗" />';
    if (kind === "rabbit") return '<img class="sticker-img" src="sticker-rabbit.png?v=16" alt="小兔" />';
    if (kind === "deer") return '<img class="sticker-img" src="sticker-deer.png?v=16" alt="小鹿" />';
    if (kind === "hedgehog") return '<img class="sticker-img" src="sticker-hedgehog.png?v=16" alt="刺猬" />';
    return "";
  }
